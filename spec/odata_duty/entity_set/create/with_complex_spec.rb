...
class CreateTestComplex < OdataDuty::ComplexType
...
class CreateComplexTestSet < OdataDuty::EntitySet
  entity_type CreateComplexTestEntity
...
class InvalidPropertyTestSet < OdataDuty::EntitySet
  entity_type CreateComplexTestEntity
...
RSpec.describe OdataDuty::EntitySet, 'Can create' do
  subject(:schema) { CreateComplexTestSchema }
    ...
    context 'with complex' do
      ...
      describe 'datetime_list' do
        it do
          ...
          expect(response['complex']).to include('datetime_list' => %w[2021-01-01T00:00:00+00:00
