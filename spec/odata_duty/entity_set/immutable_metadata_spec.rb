...
class ImmutableMetadataEntity < OdataDuty::EntityType
...
class ImmutableMetadataSet < OdataDuty::EntitySet
  entity_type ImmutableMetadataEntity
end

class ImmutableMetadataSchema < OdataDuty::Schema
  base_url 'http://localhost:3000/api'
  entity_sets [ImmutableMetadataSet]
end

RSpec.describe OdataDuty::Schema, 'Immutable property metadata' do
  subject(:metadata_xml) { ImmutableMetadataSchema.metadata_xml }
