...
class SelectMemoEntity < OdataDuty::EntityType
...
class SelectMemoSet < OdataDuty::EntitySet
  entity_type SelectMemoEntity
...
class SelectMemoSchema < OdataDuty::Schema
  base_url 'http://localhost:3000/api'
  entity_sets [SelectMemoSet]
end

RSpec.describe OdataDuty::EntitySet, '$select property ordering is normalized when memoized' do
  subject(:schema) { SelectMemoSchema }
