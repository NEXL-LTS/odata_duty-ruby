...
class GetMcpReadResolver < OdataDuty::SetResolver
  def od_after_init
    @records = GetMcpBuilderRecord.all
  end
...
class GetMcpWriteOnlyResolver < OdataDuty::SetResolver
  def create(params)
    GetMcpBuilderRecord.new('new', params.name, params.sku)
  end
end

class GetMcpIntegerResolver < OdataDuty::SetResolver
  def individual(id)
  ...
  RSpec.describe SchemaBuilder::EntitySet, 'MCP get tool' do
    subject(:schema) do
      SchemaBuilder.build(namespace: 'SampleSpace', host: 'localhost', base_path: '') do |s|
        entity = s.add_entity_type(name: 'GetMcpBuilderEntity') do |et|
          et.property_ref 'id', String
          et.property 'name', String
          et.property 'sku', String, nullable: false
        end
        numbers = s.add_entity_type(name: 'GetMcpNumberEntity') do |et|
